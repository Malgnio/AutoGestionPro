          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.formGrid}>
              ...
              <View style={styles.formField}>
                ...
                <TextInput style={styles.input} value={model} onChangeText={setModel} placeholderTextColor={Colors.textLight} />
              </View>
              <View style={styles.formField}>
                <Text style={styles.label}>Chasis</Text>
                <TextInput style={styles.input} value={chassis} onChangeText={setChassis} placeholderTextColor={Colors.textLight} autoCapitalize="characters" />
              </View>
              <View style={styles.formField}>
                <Text style={styles.label}>OdV</Text>
                <TextInput style={styles.input} value={odv} onChangeText={setOdv} placeholderTextColor={Colors.textLight} />
              </View>
              <View style={styles.formField}>
...
const styles = StyleSheet.create({
  ...
  formCard: { backgroundColor: Colors.white, borderRadius: 16, padding: 36, width: 560, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 20 },
